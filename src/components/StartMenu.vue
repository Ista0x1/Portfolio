<template>
  <div class="menu" style="z-index: 1000000">
    ...
    <div class="socials">
      <a href="https://www.instagram.com/ista0x1/" target="_blank">
        <div class="bar">
          <img
            class="social-image"
      ...
      <a
        href="https://www.linkedin.com/in/ista0x1"
        target="_blank"
      >
        <div class="bar">
      ...
      <a href="https://twitter.com/IsmailIsta2" target="_blank">
        <div class="bar">
          <img class="social-image" src="@/assets/iPhone-Icons/Twitter.webp" />
          <u>T</u>witter
        </div>
      </a>
      <a href="https://github.com/Ista0x1" target="_blank">
        <div class="bar">
