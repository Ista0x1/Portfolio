...
<template>
  ...
  >
    ...
    <form
      ...
      action="https://docs.google.com/forms/d/e/1FAIpQLSeYVo_3NWGczyxeSpPXzYCPi8uYnnx7REJexXM82XcPShOzgA/formResponse"
      class="window"
      id="container"
      :class="{
        ...
        <div class="scroll-container">
          <div class="container-details">
            ...
            <div class="subject-container">
              ...
              <div class="receipient">Ista</div>
            </div>
            <hr />
            <div class="subject-container">
            <p style="margin: 8px">Subject:</p>
            <input
              name="entry.1825664933"
              class="subject"
              v-model="mailSubject"
